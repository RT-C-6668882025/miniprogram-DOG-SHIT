...
我现在是一名艺术专业的专科大二学生，不是计算机专业出身，也没有系统的编程背景，基本上全程vibecoding吧...

这个项目最开始的创意来源于抖音上的dog shit论文投稿的视频

我从零开始构思，边学边做摸索出来的

小程序的基本功能已经完善，但功能完整性上会存在一些缺陷，比如开场动画可能被我删了...具体哪些问题我也不太清楚了...

不过可以肯定的是，不用担心运行不了，只是想要花哨一点，炫酷一点，装b一点得自己改改

有些功能是开发过程中加了又删、改了又改的

本项目不是内测中最好的一版，最好一版的源代码我上传过微信小程序，现在忘记在哪了，不过改一改也差不多

这个项目我不想维护了，如果有缘人看到了，就拿去玩吧
