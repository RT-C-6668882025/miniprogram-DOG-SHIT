...
const highlight = require('./utils/highlight.min.js');
const hljsJs = require('./utils/hljs_javascript.min.js');
const hljsCss = require('./utils/hljs_css.min.js');
const { addCustomClassPlugin, copy } = require('./utils/plugin');
Component({
  options: {
    virtualHost: true,
  },
